...
typedef struct {
     ...
     * The snapshot is a mipmap pyramid: mip 0 is a copy of the opaque target,
     * mips 1..N are generated by successive linear downsample passes. The
     * transmission shader samples at a roughness-dependent LOD to get cheap
     * rough transmission blur. `opaque_snapshot_view` covers all mips. */

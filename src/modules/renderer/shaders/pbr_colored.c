...
static const char *kShaderSource =
    ...
    "  @location(9) emissive_color : vec4<f32>,\n"
    "  @location(10) emissive_strength : f32\n"
    "};\n"
    "struct VertexOutput {\n"
    ...
    "  @location(6) emissive_strength : f32\n"
    "};\n"
    ...
    "  out.emissive_color = input.emissive_color;\n"
    ...
    "  let emissive = input.emissive_color.rgb * max(input.emissive_strength, 0.0);\n"

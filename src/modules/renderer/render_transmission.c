...
#define FLECS_ENGINE_OPAQUE_SNAPSHOT_PREFILTER_SAMPLES_MIP_2  32u
#define FLECS_ENGINE_OPAQUE_SNAPSHOT_PREFILTER_SAMPLES_MIP_3  64u
#define FLECS_ENGINE_OPAQUE_SNAPSHOT_PREFILTER_SAMPLES_MIP_4  512u
#define FLECS_ENGINE_OPAQUE_SNAPSHOT_PREFILTER_SAMPLES_MIP_5  1024u
